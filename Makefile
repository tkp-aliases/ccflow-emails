...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_emails
	python -m ruff format --check ccflow_emails
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_emails
	python -m ruff format ccflow_emails
...
test:  ## run python tests
	python -m pytest -v ccflow_emails/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_emails/tests --cov=ccflow_emails --cov-report term-missing --cov-report xml
